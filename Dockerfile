...
#                     PHP                        #
##################################################
FROM php:${PHP_VERSION}-fpm-alpine AS sylius_order_now_plugin_php
...
#                     NODEJS                     #
##################################################
FROM node:${NODE_VERSION}-alpine AS sylius_order_now_plugin_nodejs
...
COPY --from=sylius_order_now_plugin_php /srv/sylius/package.json ./package.json
COPY --from=sylius_order_now_plugin_php /srv/sylius/gulpfile.babel.js ./gulpfile.babel.js
COPY --from=sylius_order_now_plugin_php /srv/sylius/.babelrc ./.babelrc
COPY --from=sylius_order_now_plugin_php /srv/sylius/.eslintrc.js ./.eslintrc.js
COPY --from=sylius_order_now_plugin_php /srv/sylius/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/gulpfile.babel.js ./vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/gulpfile.babel.js
COPY --from=sylius_order_now_plugin_php /srv/sylius/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/Resources/private vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/Resources/private/
...
#                     NGINX                      #
##################################################
FROM nginx:${NGINX_VERSION}-alpine AS sylius_order_now_plugin_nginx
...
COPY --from=sylius_order_now_plugin_php /srv/sylius/public public/
COPY --from=sylius_order_now_plugin_nodejs /srv/sylius/public public/
...
#                     CHROME                     #
##################################################
FROM ubuntu:focal AS sylius_order_now_plugin_chrome
